    ...
    <header className="border-b bg-white/70 backdrop-blur">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden sm:flex items-center gap-6 text-sm text-gray-700">
          ...
          <a href="#" target="_blank" rel="noreferrer" className="hover:text-black">最右网页版</a>
        </nav>
      </div>
      {menuOpen && (
        <div className="sm:hidden border-t">
          <nav className="container mx-auto px-4 py-3 flex flex-col gap-3 text-sm text-gray-700">
            ...
            <a href="#" target="_blank" rel="noreferrer" className="hover:text-black" onClick={() => setMenuOpen(false)}>最右网页版</a>
          </nav>
        </div>
      )}
    </header>
